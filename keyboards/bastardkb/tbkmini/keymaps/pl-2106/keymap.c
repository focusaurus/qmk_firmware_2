...
// left hand
KC_TRNS, LGUI(KC_TAB), KC_BSPC, KC_SPC, KC_DEL, KC_PGUP,
...
KC_BSLS, KC_LBRC /*TD(TD_LBRC)*/, KC_RBRC /*TD(TD_RBRC)*/, KC_PIPE, RSFT(KC_MINUS), KC_TRNS,
KC_TRNS, KC_TRNS, KC_TRNS
...
// right hand
KC_COMMA, KC_7, KC_8, KC_9, KC_MINUS, KC_TRNS,
KC_DOT, KC_4, KC_5, KC_6, KC_0, KC_TRNS,
KC_COLON, KC_1, KC_2, KC_3, LSFT(KC_MINUS), KC_TRNS,
KC_TRNS, KC_TRNS, KC_TRNS

), [BANG] = LAYOUT_split_3x6_3(
...
), [KBFN] = LAYOUT_split_3x6_3(

// left hand
TG(VIEW), KC_NO, KC_NO, KC_VOLU, KC_NO, KC_NO,
KC_CAPSLOCK, KC_NO, KC_NO, KC_MUTE, RESET, KC_NO,
